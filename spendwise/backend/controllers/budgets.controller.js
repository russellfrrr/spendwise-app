...
// GET /monthly/expense
const getMonthlyExpenseBudgetsController = async (req, res) => {
  try {
    const userId = req.user._id;
    const budgets = await getMonthlyExpenseBudgetsService(userId);

    const responseObj = {
      success: true,
      message: 'Fetched all monthly expense successfully!',
      data: budgets,
    }
...
// GET /monthly/summary
const getMonthlyBudgetSummaryController = async (req, res) => {
  try {
    const userId = req.user._id;
    const summary = await getMonthlyBudgetSummaryService(userId);

    const responseObj = {
      success: true,
      message: 'Fetched monthly budget summary successfully!',
      data: summary,
    }
...
export {
  ...
  getMonthlyExpenseBudgetsController,
